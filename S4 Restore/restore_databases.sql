...
CREATE PROC dbo.restore_databases 
	...
	@RpoWarningThreshold			nvarchar(20)	= NULL,				-- Can be 2 part: FULL-Spec, SIMPLE-Spec. Only evaluated if non-NULL. CAN be specified as 'vector' or ... as 'vector, vector' - in which case apply as FULL + SIMPLE recovery RPOs.
