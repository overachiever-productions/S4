...
- **[HackStart-SQLServer.ps1](/documentation/apis/emergency_start_sql_server.md):** - PowerShell script to simplify the process of starting SQL Server from the command-line (for disaster-recovery and other emergency administrative needs).
