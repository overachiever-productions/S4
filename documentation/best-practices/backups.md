...
[S4 Docs Home](/readme.md) > [S4 Best Practices](/documentation/best-practices/) >  Managing SQL Server Backups with S4

# Managing SQL Server Backups with S4

## Table of Contents 
- [Core S4 Backup APIs](#core-s4-backup-apis)
- [Best-Practices for SQL Server Backups](#best-practices-for-sql-server-backups)
    - [Concerns about Backups and Resource Usage](#concerns-about-the-resource-overhead-associated-with-backups)
    - [FULL Backups - Recommendations and Frequency](#full-backups---recommendations-and-frequency-of-backups)
...
## Core S4 Backup APIs
While the information in this document pertains to both SQL Server Best Practices for Backups AND Best Practices for leveraging S4 to help ensure optimal backups, detailed documentation for the actual S4 responsible for handling backups can be found in the [Backups section of S4's API Documentation](/documentation/apis.md#sql-server-backups-and-utilities).
...
### Concerns About the Resource Overhead Associated with Backups 
...
Otherwise, key reasons why you might want to address customized backup requirements would include scenarios like: 
...
EXEC admindb.dbo.dbo.backup_databases
    ...
    @CopyToBackupDirectory = N'\\BackupServer\ProdSQL', 
    @BackupRetention = '72 hours', 
    @CopyToRetention = '96 hours';
