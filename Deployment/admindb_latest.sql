/*
	...
	NOTES:
		- This script will either install/deploy S4 version 8.0.3223.3 or upgrade a PREVIOUSLY deployed version of S4 to 8.0.3223.3.
	...
	Deployment Steps/Overview: 
		...
		4. Deploy S4 version 8.0.3223.3 code to admindb (overwriting any previous versions). 
...
DECLARE @CurrentVersion varchar(20) = N'8.0.3223.3';
...
GO
	...
	-- [v8.0.3223.3.3] - License/Code/Details/Docs: https://git.overachiever.net/Repository/Tree/00aeb933-08e0-466e-a815-db20aa979639 
...
IF (SELECT admindb.dbo.get_s4_version('8.0.3223.3')) < 7.0 BEGIN
