/*
	...
	NOTES:
		- This script will either install/deploy S4 version 8.8.3647.2 or upgrade a PREVIOUSLY deployed version of S4 to 8.8.3647.2.
	...
	Deployment Steps/Overview: 
		...
		4. Deploy S4 version 8.8.3647.2 code to admindb (overwriting any previous versions). 
...
DECLARE @CurrentVersion varchar(20) = N'8.8.3647.2';
...
GO
	...
	-- [v8.8.3647.2] - License, Code, & Docs: https://github.com/overachiever-productions/s4/ 
...
IF (SELECT admindb.dbo.get_s4_version('8.8.3647.2')) < 7.0 BEGIN
...
CREATE PROC dbo.load_header_details 
	...
	@FirstLSN					decimal(25,0)				OUTPUT, 
	@LastLSN					decimal(25,0)				OUTPUT
AS
	SET NOCOUNT ON; 
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DECLARE @CurrentVersion varchar(20) = N'8.8.3647.2';
DECLARE @VersionDescription nvarchar(200) = N'Proviso Testing';
