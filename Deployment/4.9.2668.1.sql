...
/*
	...
	NOTES:
		- This script will either install/deploy S4 version 4.9.2668.1 or upgrade a PREVIOUSLY deployed version of S4 to 4.9.2668.1.
	...
	Deployment Steps/Overview: 
		...
		6. Deploy S4 version 4.9.2668.1 code to admindb (overwriting any previous versions). 
...
DECLARE @CurrentVersion varchar(20) = N'4.9.2668.1';
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DECLARE @CurrentVersion varchar(20) = N'4.9.2668.1';
DECLARE @VersionDescription nvarchar(200) = N'Perf and formatting fixes to list_processes and list_transactions';
