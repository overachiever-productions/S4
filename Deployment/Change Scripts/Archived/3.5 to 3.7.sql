...
/*
	Primary Changes:
		1. Streamlined Deployment / Version-Tracking. (Instead of EVERY sproc/udf containing the current/associated S4 version, there's a comment on how to use a query to pull version info from Extended Properties. 
		2. Added Automation Routines for T-Log management (i.e., shrinking for multi-tenant and disk-constrained DBs). 
		3. Minor Bug Fixes. 
